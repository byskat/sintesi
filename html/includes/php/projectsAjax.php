<?php
	...
	if($action == "update"){
        ...
        //Proceso els valors a retornar pel servidor. Aquests valors em permetran actualitzar dinamicament el quadre de registre
		...
		//Si no es troba cap projecte amb el mateix nom ni s'ha trobat a id de la connexió al projecte insereixo el projecte i la connexió d'equip amb projecte.
