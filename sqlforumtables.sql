...
INSERT INTO `forumAnswer` (`question_id`, `a_id`, `a_name`, `a_email`, `a_answer`, `a_datetime`) VALUES
...
INSERT INTO `forumQuestion` (`id`, `id_team`, `open`, `topic`, `detail`, `name`, `email`, `datetime`, `view`, `reply`) VALUES
